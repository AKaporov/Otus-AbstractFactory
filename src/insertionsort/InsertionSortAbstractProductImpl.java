 ...
 * После этого остается итерировать массив и расширять отсортированную часть массива одним элементом с каждой новой
 * итерацией.
 * <p>
 ...
 * <p>
 * В приведенном ниже массиве жирная часть отсортирована в порядке возрастания.
 * Посмотрите что произойдет в этом случае:
 ...
 * 3 4 5 7 8 2 1 9 6
 * <p>
 * Теперь вы видите, что отсортированная часть дополнилась элементом. Каждая следующая итерация делает то же самое, и к
 * концу вы получите отсортированный массив!
 * <p>
 * Временная сложность:
 ...
 */
public class InsertionSortAbstractProductImpl implements InsertionSortAbstractProduct {
    @Override
